    ...
    <main className="flex min-h-screen flex items-center">
      ...
      <section className="px-4 py-16 md:p-8 lg:p-8 w-full">
        <div className="pb-8 mb-8 border-b border-gray-300 lg:w-3/4 xl:w-2/3">
          ...
          <p>Jump in one to see what&apos;s new and start interacting with your fellow comm-you-nity members..</p>
        </div>
      ...
      <section className="px-4 py-16 md:p-8 lg:p-16 w-full">
        <div>
        <h1 className="font-bold text-2xl md:text-3xl pb-4">You do not belong to any communities</h1>
          <p className="mb-8">Join or create one to begin your comm-you-nity journey.</p>
