        ...
        <section className="mx-auto py-10 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center max-w-screen-xl">
          <div className="md:w-4/5 md:w-full mx-auto">
            ...
            <p className="font-medium text-lg">
              ...
              unites residents, schools, churches, and businesses to share news,
              events, and offers. Prioritizing your privacy, we don&apos;t sell
              your data or use intrusive algorithms. Join us today to build
              genuine connections and strengthen community bonds.
            </p>
