    ...
    <nav>
      ...
      <section className='flex flex-row justify-between px-4 xl:p-0 start-0 items-center w-[100%] max-w-screen-xl mx-auto'>
        ...
        <section className="flex gap-8 flex-wrap justify-end">
          <Link href="/communities" className="flex gap-2 hover:text-gray-400 transition-all duration-500 ease-out items-center">
          ...
          <Link href="/login" className="flex gap-2 hover:text-gray-400 transition-all duration-500 ease-out items-center">
